...
import nz.ac.aut.ense701.gameModel.gameTiles.Food;
import nz.ac.aut.ense701.gameModel.gameTiles.Tool;
...
public class PlayerTest extends junit.framework.TestCase
{
	...
	@Test public void testAdjustStaminaPastZero()
	{
		player.adjustStamina(4.0);
		assertEquals(25.0, player.getStaminaLevel(), 0.01);
	}

	@Test public void testAdjustStaminaByNegative()
	{
		player.adjustStamina(+1);
		assertEquals(25, player.getStaminaLevel(), 0.01);
	}

	@Test public void testhasStaminaToMoveEnoughStamina()
	{
		assertTrue(player.hasStaminaToMove(Terrain.SAND));
	}

	@Test public void testhasStaminaToMoveNotEnoughStaminaForTerrain()
	{
		player.reduceStamina(23);
		assertFalse(player.hasStaminaToMove(Terrain.SCRUB));
	}

	@Test public void testhasStaminaToMoveNotEnoughStaminaFullBackpack()
	{
	...
	@Test public void testhasStaminaToMoveNotEnoughStaminaPartlyFullBackpack()
	{
	...
	@Test public void testhasItemWithItem()
	{
		player.collect(sandwich);
		assertTrue(player.hasItem(sandwich));
	}

	@Test public void testhasItemNoItem()
	{
		assertFalse(player.hasItem(sandwich));
	}

	@Test public void testHasTrapWithTrap()
	{
	...
	@Test public void testHasTrapNoTrap()
	{
		assertFalse(player.hasTrap());
	}

	@Test public void testGetTrap()
	{
		Tool trap = new Tool(playerPosition, "Trap", "A predator trap", 1.0, 1.0);
		player.collect(trap);
	...
	@Test public void testCollectValidItemThatFits()
	{
	...
	@Test public void testCollectDuplicateItem()
	{
		assertTrue(player.collect(sandwich));
		assertFalse(player.collect(sandwich));
	}

	@Test public void testCollectItemMaxWeight()
	{
	...
	@Test public void testCollectItemTooHeavy()
	{
	...
	@Test public void testCollectItemTooBig()
	{
	...
	@Test public void testDropValidItem()
	{
		assertTrue(player.collect(sandwich));
		assertTrue(player.hasItem(sandwich));
	...
	@Test public void testDropInvalidItem()
	{
		assertFalse(player.drop(sandwich));
	}

	@Test public void testMoveToPositionEnoughStamina()
	{
	...
	@Test public void testMoveToPositionNotEnoughStamina()
	{
		Position newPosition = new Position(island, 0, 1);
		player.reduceStamina(23);
