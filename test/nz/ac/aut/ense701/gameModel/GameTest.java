...
import nz.ac.aut.ense701.gameModel.gameTiles.*;
...
public class GameTest extends junit.framework.TestCase
{
	 ...
	 * test classes.
	 */
	@Test public void testGetNumRows()
	{
		assertEquals("Check row number", game.getNumRows(), 10);
	}

	@Test public void testGetNumColumns()
	{
	...
	@Test public void testGetInitialState()
	{
		assertEquals("Wrong initial state", game.getState(), GameState.PLAYING);
	}

	@Test public void testGetPlayerValues()
	{
	...
	@Test public void testIsPlayerMovePossibleValidMove()
	{
	...
	@Test public void testIsPlayerMovePossibleInvalidMove()
	{
		//At start of game player has valid moves EAST, West & South
		assertFalse("Move should not be valid", game.isPlayerMovePossible(MoveDirection.NORTH));
	}

	@Test public void testCanCollectCollectable()
	{
	...
	@Test public void testCanCollectNotCollectable()
	{
	...
	@Test public void testCanUseFoodValid()
	{
	...
	@Test public void testCanUseTrapValid()
	{
	...
	@Test public void testCanUseTrapNoPredator()
	{
		//Trap can be used if there is a predator here
	...
	@Test public void testCanUseTool()
	{
	...
	@Test public void testCanUseToolNoTrap()
	{
		//Screwdriver can be used if player has a broken trap
		Item tool = new Tool(playerPosition, "Screwdriver", "A good tool to fix a trap", 1.0, 1.0);
		Tool trap = new Tool(playerPosition, "Trap", "A predator trap", 1.0, 1.0);
	...
	@Test public void testCanUseToolTrapNotBroken()
	{
		//Screwdriver can be used if player has a broken trap
		Item tool = new Tool(playerPosition, "Screwdriver", "A good tool to fix a trap", 1.0, 1.0);
		Tool trap = new Tool(playerPosition, "Trap", "A predator trap", 1.0, 1.0);
	...
	@Test public void testGetKiwiCountInitial()
	{
	...
	@Test public void testCollectValid()
	{
	...
	@Test public void testCollectNotCollectable()
	{
	...
	@Test public void testDropValid()
	{
		Item food = new Food(playerPosition, "Sandwich", "Yummy", 1.0, 1.0, 1.0);
		island.addOccupant(playerPosition, food);
		game.collectItem(food);
	...
	@Test public void testDropNotValidPositionFull()
	{
		Item food = new Food(playerPosition, "Sandwich", "Yummy", 1.0, 1.0, 1.0);
		island.addOccupant(playerPosition, food);
		game.collectItem(food);
	...
	@Test public void testUseItemFoodCausesIncrease()
	{
	...
	@Test public void testUseItemTrap()
	{
	 ...
	 */
	@Test public void testPredatorTrapMessage()
	{
		Item trap = new Tool(playerPosition, "Trap", "Rat trap", 1.0, 1.0);
		player.collect(trap);
		Predator predator = new Predator(playerPosition, "Rat", "Norway rat");
	...
	@Test public void testUseItemTrapFinalPredator()
	{
	...
	@Test public void testUseItemBrokenTrap()
	{
	...
	@Test public void testUseItemToolFixTrap()
	{
		Tool trap = new Tool(playerPosition, "Trap", "Rat trap", 1.0, 1.0);
		trap.setBroken();
		player.collect(trap);
	...
	@Test public void testPlayerMoveValidNoHazards()
	{
	...
	@Test public void testPlayerMoveFatalHazard()
	{
	...
	@Test public void testPlayerMoveDeadPlayer()
	{
		player.kill();
		assertFalse(game.playerMove(MoveDirection.SOUTH));
	}

	@Test public void testPlayerMoveNonFatalHazardNotDead()
	{
		int stamina = player.getStaminaLevel();
		Position hazardPosition = new Position(island, playerPosition.getRow() + 1, playerPosition.getColumn());
	...
	@Test public void testPlayerMoveNonFatalHazardDead()
	{
		Position hazardPosition = new Position(island, playerPosition.getRow() + 1, playerPosition.getColumn());
		Hazard fatal = new Hazard(hazardPosition, "Cliff", "Not so steep cliff", 0.5);
		island.addOccupant(hazardPosition, fatal);
	...
	@Test public void testPlayerMoveNotEnoughStamina()
	{
	...
	@Test public void testCountKiwi()
	{
	...
	@Test public void testAnswerQuestionCorrect()
	{
		assertTrue("Check player moves", trapAllPredators());
		assertTrue("Game should be won", game.getState() == GameState.WINNABLE);
		game.answerQuestion();
		assertTrue("Question right", game.getCurrentLevelNumber() == 2);
	}

	@Test public void testAnswerQuestionIncorrect()
	{
		assertTrue("Check player moves", trapAllPredators());
		assertTrue("Game should be won", game.getState() == GameState.WINNABLE);
		game.answerQuestion();
		assertTrue("Question wrong", game.getCurrentLevelNumber() == 1);
	}
