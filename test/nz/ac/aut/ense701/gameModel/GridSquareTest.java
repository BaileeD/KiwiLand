...
import nz.ac.aut.ense701.gameModel.gameTiles.Occupant;
import nz.ac.aut.ense701.gameModel.gameTiles.Predator;
...
public class GridSquareTest extends junit.framework.TestCase
{
	...
	@Test public void testHasOccupantPresent()
	{
		assertTrue(occupiedSquare.hasOccupant(apple));
	}

	@Test public void testHasOccupantNotPresent()
	{
		assertFalse(emptySquare.hasOccupant(apple));
	}

	@Test public void testGetOccupantStringRepresentationNoOccupants()
	{
		assertEquals("", emptySquare.getOccupantStringRepresentation());
	}

	@Test public void testGetOccupantStringRepresentationSingle()
	{
		assertEquals("E", occupiedSquare.getOccupantStringRepresentation());
	}

	@Test public void testGetOccupantStringRepresentationMultipleOccupants()
	{
	...
	@Test public void testGetOccupants()
	{
		// Add another occupant
		Tool trap = new Tool(position, "Trap", "A predator trap", 1.0, 2.0);
		occupiedSquare.addOccupant(trap);
	...
	@Test public void testAddOccupantWhenNotFull()
	{
		Tool trap = new Tool(position, "Trap", "A predator trap", 1.0, 2.0);
	...
	@Test public void testAddOccupantNull()
	{
		assertFalse(occupiedSquare.addOccupant(null));
	}

	@Test public void testAddOccupantWhenFull()
	{
		// Add another occupant
		Tool trap = new Tool(position, "Trap", "A predator trap", 1.0, 2.0);
		occupiedSquare.addOccupant(trap);
	...
	@Test public void testAddOccupantDuplicate()
	{
	...
	@Test public void testRemoveOccupantWhenPresent()
	{
		assertTrue(occupiedSquare.removeOccupant(apple));
		assertFalse(occupiedSquare.hasOccupant(apple));
	}

	@Test public void testRemoveOccupantWhenNotPresent()
	{
		assertFalse(emptySquare.removeOccupant(apple));
	}

	@Test public void testRemoveOccupantWhenNull()
	{
