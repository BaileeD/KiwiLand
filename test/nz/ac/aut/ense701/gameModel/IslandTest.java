...
import nz.ac.aut.ense701.gameModel.gameTiles.Kiwi;
...
public class IslandTest extends junit.framework.TestCase
{
	...
	@Test public void testRemoveOccupantOnIslandValidOccupant()
	{
		assertTrue(testIsland.addOccupant(onIsland, cat));
		assertTrue(testIsland.hasOccupant(onIsland, cat));
	...
	@Test public void testRemoveOccupantPositionNotOnIsland()
	{
		assertTrue(testIsland.addOccupant(onIsland, cat));
	...
	@Test public void testUpdatePlayerPosition()
	{
	...
	@Test public void testGetPredator()
	{
		testIsland.addOccupant(onIsland, cat);
