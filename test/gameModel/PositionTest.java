...
public class PositionTest extends junit.framework.TestCase
{
	...
	@Test public void testPositionValidParametersOnIsland()
	{
		assertTrue(onIsland.isOnIsland());
	}

	@Test public void testPositionValidParameterNotOnIsland()
	{
		assertFalse(notOnIsland.isOnIsland());
	}

	@Test public void testIllegalArgumentNoIsland() throws Exception
	{
		try
		{
	...
	@Test public void testIllegalArgumentRowNegative() throws Exception
	{
		try
		{
	...
	@Test public void testIllegalArgumentRowTooLarge() throws Exception
	{
		try
		{
	...
	@Test public void testIllegalArgumentColumnNegative() throws Exception
	{
		try
		{
	...
	@Test public void testIllegalArgumentColumnTooLarge() throws Exception
	{
		try
		{
	...
	@Test public void testRemoveFromIsland()
	{
		onIsland.removeFromIsland();
		assertFalse(onIsland.isOnIsland());
	}

	@Test public void testGetNewPositionNull() throws Exception
	{
		try
		{
	...
	@Test public void testGetNewPositionNotOnIsland()
	{
		assertEquals(notOnIsland.getNewPosition(MoveDirection.NORTH), null);
	}

	@Test public void testGetNewPositionValidDirection()
	{
