...
public class GameScreenFrame extends JFrame implements GameEventListener, KeyListener
{
	 ...
	 */
	public GameScreenFrame(Game game)
	{
	...
	private void initPlayerInterface()
	{
		...
		btnSave.setMaximumSize(new Dimension(100, 23));
	...
	{
            SaveGameDialog dialog = new SaveGameDialog(this, this.game);
