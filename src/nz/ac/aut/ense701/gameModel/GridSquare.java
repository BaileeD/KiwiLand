...
public class GridSquare
{
	...
	/**
	 * Check if this grid square has already been explored (ie visited by
	 * player).
	 *
	...
	/**
	 * Check if this grid square is visible to the player. Squares are visible
	 * if they: are visitable and adjacent to the player's current position
	 * already explored by the player
	 *
	 * @return true is the grid square is visible to the player, false if not.
	 */
	 ...
	 *
	 * @param player the player on the square or null if there is no player
	 */
	...
	/**
	 * Adds an occupant to a GridSquare if the occupant is not already there and
	 * if the capacity of the grid square is not yet exceeded.
	 *
	 ...
	 * @return true if occupant was removed, false if it was not in there (or
	 * not valid)
	 */
