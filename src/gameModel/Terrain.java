 ...
 * @version July 2011
 *          <p>
 *          Maintenance History Representation strings changed Anne July 2011
 */
public enum Terrain
{
	SAND(".", 1.0), FOREST("*", 2.0), WETLAND("#", 2.5), SCRUB("^", 3.0), WATER("~", 4.0);

	private final double difficulty;
	private final String stringRep;

	/**
	 * Creates a new terrain with a given difficulty and a string representation
	 *
	 ...
	 * @return the terrain that is associated with this terrain, or null if the
	 * string is invalid
	 */
