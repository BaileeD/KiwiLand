...
/**
 * This class represents food that can be found on the island and supplies
 * energy when being consumed (used) by the player.
 *
 * @author AS
 * @version July 2011
 */
public class Food extends Item
{
	 ...
	 * @param energy      stamina contribution of the food object when the player
	 *                    uses the object
	 */
