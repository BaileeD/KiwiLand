...
public class Island {
    ...
    private Position previousKiwiPos;
    ...
    /**
     * Update the grid and the explored & visible state of the grid to reflect
    ...
    /**
     * Produces a textual representation of the island on the console. This
     * exists for debugging purposes during early development.
     */
    public void draw() {
     ...
     */
    /**
     * Populates the island grid with GridSquare objects Terrain defaults to
     * water. Actual terrain details will be updated later when data from file
     * read.
     */
    ...
    /**
     * Private convenience method to change the setVisibilityForGameAndMenu of
     * grid squares.
     *
